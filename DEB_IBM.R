...
snail_control_days = 0 # run multiple molluscicide days per sim
biocontrol = 1 # run biocontrol?
be_event <- 1 # 2 3 selevct biocontrol event (diff snail snack size)
init_pop_vec <- c(50,150,500,1000,2000)
...
for(be_event in 1:3){
  ...
  # for(me_im_event in 1:1){ # 1:5
  # for(me_event in 1:1){ # 1:3. run all me event scenarios and save to file.
  ...
  if(biocontrol==1){
    fhh = paste0(resource_type,"_be",be_event,"_init",60);fhh
