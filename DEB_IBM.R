...
# biocontrol
be_event <- 2 # 2 3 selevct biocontrol event (diff snail snack size)
...
global_output_fh = "R:/CivitelloLab/matt/schisto_ibm/biocontrol_sims/detritus_be4_hostpop60_predpop10.R"
