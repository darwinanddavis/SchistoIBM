...
hailmary <- 1 # run hailmary sims separately to other molluscicide sims
detr_impact = 0 # run detritus impact?
biocontrol = 0 # run biocontrol?
no_control <- 0 # run normal no control sims

# snail control
me_event <- 8 # 1 = on day 30, every month, skip a month. 8 = hailmary
...
for(rn in 1:rep_num){
  ...
  for(me_im_event in 4){ # 1:5 # me impact (0.69, 1.39, 2.3 ...)
...
global_output_fh = "R:/CivitelloLab/matt/schisto_ibm/plos_sims/hailmary/detritus_hailmary60_rep3.R"
