...
# me_event <- 3 # 1 = every 2 weeks, 2 = every month, 3 = every 2 months 
me_im_event <- 3 # 1 = 0.69, 2 = 1.39, 3 = 2.30, 4 = 3.0, 5 = 4.60 for me_im
...
# # for algae and det 
# for(rn in 1:3){ # reps
# for(me_im_event in 1:5){ # run all five me_im_event scenarios and save to file. 
...
fhh = paste0("global_output_",resource_type,"_meday",306090120);fhh
...
global_output_fh = paste0(wd,"/nih_grant_sims/final/",fhh,".R"); global_output_fh
...
# setwd("R:/CivitelloLab/matt/schisto_ibm/nih_grant_sims")
# pdf(paste0(getwd(),"/",resource_type,"_me",me_event,"_meim",me_im_event,"_rep",rn,"_detr_impact0.pdf"),onefile=T,width=15,height=10,paper="a4r")
